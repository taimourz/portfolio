...
<div class="article-header">
  <div class="showcase">
    <h3 class="showcase-title">OpenAPI SDK Generator</h3>
    <div style="display:flex; flex-direction:column;">    
      <a href="https://github.com/taimourz/openapi_sdk_generator_gem" target="_blank" class="showcase-link">
        Explore GitHub
      </a>
      <a href="https://rubygems.org/gems/openapi_sdk_generator_gem" target="_blank" class="showcase-link">
        RubyGems.org
      </a>
    </div>
...
<div class="showcase">
  <h3 class="showcase-title">Online Store mobile App</h3>
